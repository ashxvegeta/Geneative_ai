...
class Review(BaseModel):
   ...
   pros: Optional[list[str]] = Field(default=None,description="Write down all the  pros mentioned in the review inside a list")
   cons: Optional[list[str]] = Field(default=None,description="Write down all the cons mentioned in the review inside a list")
